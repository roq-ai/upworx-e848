  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Upworx: Empowering Owners, Recruiters, and Freelancers to Create, Collaborate and Thrive in a Dynamic Job Marketplace"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Upworx: Empowering Owners, Recruiters, and Freelancers to Create, Collaborate and Thrive in a Dynamic Job Marketplace`}
            </Text>
            <Box
